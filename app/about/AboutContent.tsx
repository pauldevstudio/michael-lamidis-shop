...
export default function AboutContent() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative min-h-[52vh] flex items-end overflow-hidden pt-28 pb-20">
        <Image src="/hero-about.webp" alt="" fill className="object-cover object-center" sizes="100vw" />
        ...
        <div className="relative z-10 container mx-auto px-5 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <motion.p
            ...
            className="text-white/55 text-[0.95rem] sm:text-[1.05rem] leading-[1.7] max-w-xl mt-5"
          >
            {__subheadline}
          </motion.p>
        </div>
