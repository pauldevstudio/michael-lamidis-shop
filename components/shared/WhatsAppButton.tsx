...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-[9998] flex items-center gap-2 rounded-full bg-[#075E54] pl-3 pr-4 py-3 text-white shadow-xl shadow-black/20 ring-1 ring-black/5 transition-transform hover:scale-105 active:scale-95"
    >
