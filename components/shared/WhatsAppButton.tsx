...
/**
 * Floating WhatsApp click-to-chat button. Public pages only (skips admin/cms,
 * like the chatbot). Sits bottom-LEFT so it never collides with the chatbot
 * FAB at bottom-right. Clicks are auto-tracked as `whatsapp_click` by AutoTrack
 * (the href contains wa.me).
 */
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-[9998] flex items-center gap-2 rounded-full bg-[#25D366] pl-3 pr-4 py-3 text-white shadow-xl shadow-black/20 ring-1 ring-black/5 transition-transform hover:scale-105 active:scale-95"
    >
