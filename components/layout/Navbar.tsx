          ...
          <div className="flex items-center gap-6">
            ...
            <div className="ml-auto flex items-center gap-2 sm:gap-3">
              ...
              <Link
                ...
                className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-white/15 text-white/55 hover:text-white hover:border-white/30 hover:bg-white/10 text-[11px] font-semibold tracking-wide uppercase transition-all"
              >
